...
public class bbasemthree extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bbasemthree);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("BBA 3rd SEM Notes");
        pdfRecyclerView = findViewById(R.id.bbathreerecycler);
        reference = FirebaseDatabase.getInstance().getReference().child("Notes");
        shimmerFrameLayout = findViewById(R.id.shimmeranimation);
        linearLayout = findViewById(R.id.bbathreeshimmer);
        ...
        dbref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (!snapshot.exists()) {
                    ...
                    adapter = new EbookAdapter(bbasemthree.this, list);
                    pdfRecyclerView.setLayoutManager(new LinearLayoutManager(bbasemthree.this));
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(bbasemthree.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    @Override
